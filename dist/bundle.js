...
/***/ "./node_modules/async.queue/index.js":
/*!*******************************************!*\
  !*** ./node_modules/async.queue/index.js ***!
  \*******************************************/
...
"use strict";
eval("\n\nvar queue = __webpack_require__(/*! async.util.queue */ \"./node_modules/async.util.queue/index.js\");\n\nmodule.exports = function (worker, concurrency) {\n    return queue(function (items, cb) {\n        worker(items[0], cb);\n    }, concurrency, 1);\n};\n\n\n//# sourceURL=webpack:///./node_modules/async.queue/index.js?");

/***/ }),

/***/ "./node_modules/async.util.arrayeach/index.js":
/*!****************************************************!*\
  !*** ./node_modules/async.util.arrayeach/index.js ***!
  \****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nmodule.exports = function arrayEach(arr, iterator) {\n    var index = -1;\n    var length = arr.length;\n\n    while (++index < length) {\n        iterator(arr[index], index, arr);\n    }\n};\n\n\n//# sourceURL=webpack:///./node_modules/async.util.arrayeach/index.js?");
...
"use strict";
eval("\n\nmodule.exports = Array.isArray || function isArray(obj) {\n    return Object.prototype.toString.call(obj) === '[object Array]';\n};\n\n\n//# sourceURL=webpack:///./node_modules/async.util.isarray/index.js?");

/***/ }),

/***/ "./node_modules/async.util.map/index.js":
/*!**********************************************!*\
  !*** ./node_modules/async.util.map/index.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nmodule.exports = function noop () {};\n\n\n//# sourceURL=webpack:///./node_modules/async.util.noop/index.js?");
...
"use strict";
eval("\n\nmodule.exports = function only_once(fn) {\n    return function() {\n        if (fn === null) throw new Error('Callback was already called.');\n        fn.apply(this, arguments);\n        fn = null;\n    };\n};\n\n\n//# sourceURL=webpack:///./node_modules/async.util.onlyonce/index.js?");

/***/ }),

/***/ "./node_modules/async.util.queue/index.js":
/*!************************************************!*\
  !*** ./node_modules/async.util.queue/index.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar map = __webpack_require__(/*! async.util.map */ \"./node_modules/async.util.map/index.js\");\nvar noop = __webpack_require__(/*! async.util.noop */ \"./node_modules/async.util.noop/index.js\");\nvar isArray = __webpack_require__(/*! async.util.isarray */ \"./node_modules/async.util.isarray/index.js\");\nvar onlyOnce = __webpack_require__(/*! async.util.onlyonce */ \"./node_modules/async.util.onlyonce/index.js\");\nvar arrayEach = __webpack_require__(/*! async.util.arrayeach */ \"./node_modules/async.util.arrayeach/index.js\");\nvar setImmediate = __webpack_require__(/*! async.util.setimmediate */ \"./node_modules/async.util.setimmediate/index.js\");\n\nmodule.exports = function queue(worker, concurrency, payload) {\n    if (concurrency == null)\n        concurrency = 1;\n    else if (concurrency === 0) {\n        throw new Error('Concurrency must not be zero');\n    }\n\n    function _insert(q, data, pos, callback) {\n        if (callback != null && typeof callback !== \"function\") {\n            throw new Error(\"task callback must be a function\");\n        }\n        q.started = true;\n        if (!isArray(data)) {\n            data = [data];\n        }\n        if (data.length === 0 && q.idle()) {\n            // call drain immediately if there are no tasks\n            return setImmediate(function() {\n                q.drain();\n            });\n        }\n        arrayEach(data, function(task) {\n            var item = {\n                data: task,\n                callback: callback || noop\n            };\n\n            if (pos) {\n                q.tasks.unshift(item);\n            } else {\n                q.tasks.push(item);\n            }\n\n            if (q.tasks.length === q.concurrency) {\n                q.saturated();\n            }\n        });\n        setImmediate(q.process);\n    }\n\n    function _next(q, tasks) {\n        return function() {\n            workers -= 1;\n\n            var removed = false;\n            var args = arguments;\n            arrayEach(tasks, function(task) {\n                arrayEach(workersList, function(worker, index) {\n                    if (worker === task && !removed) {\n                        workersList.splice(index, 1);\n                        removed = true;\n                    }\n                });\n\n                task.callback.apply(task, args);\n            });\n            if (q.tasks.length + workers === 0) {\n                q.drain();\n            }\n            q.process();\n        };\n    }\n\n    var workers = 0;\n    var workersList = [];\n    var q = {\n        tasks: [],\n        concurrency: concurrency,\n        payload: payload,\n        saturated: noop,\n        empty: noop,\n        drain: noop,\n        started: false,\n        paused: false,\n        push: function(data, callback) {\n            _insert(q, data, false, callback);\n        },\n        kill: function() {\n            q.drain = noop;\n            q.tasks = [];\n        },\n        unshift: function(data, callback) {\n            _insert(q, data, true, callback);\n        },\n        process: function() {\n            while (!q.paused && workers < q.concurrency && q.tasks.length) {\n\n                var tasks = q.payload ?\n                    q.tasks.splice(0, q.payload) :\n                    q.tasks.splice(0, q.tasks.length);\n\n                var data = map(tasks, function(task) {\n                    return task.data;\n                });\n\n                if (q.tasks.length === 0) {\n                    q.empty();\n                }\n                workers += 1;\n                workersList.push(tasks[0]);\n                var cb = onlyOnce(_next(q, tasks));\n                worker(data, cb);\n            }\n        },\n        length: function() {\n            return q.tasks.length;\n        },\n        running: function() {\n            return workers;\n        },\n        workersList: function() {\n            return workersList;\n        },\n        idle: function() {\n            return q.tasks.length + workers === 0;\n        },\n        pause: function() {\n            q.paused = true;\n        },\n        resume: function() {\n            if (q.paused === false) {\n                return;\n            }\n            q.paused = false;\n            var resumeCount = Math.min(q.concurrency, q.tasks.length);\n            // Need to call q.process once per concurrent\n            // worker to preserve full concurrency after pause\n            for (var w = 1; w <= resumeCount; w++) {\n                setImmediate(q.process);\n            }\n        }\n    };\n    return q;\n};\n\n\n//# sourceURL=webpack:///./node_modules/async.util.queue/index.js?");

/***/ }),

/***/ "./node_modules/async.util.setimmediate/index.js":
/*!*******************************************************!*\
  !*** ./node_modules/async.util.setimmediate/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./node_modules/window.ipfs-fallback/index.js":
/*!****************************************************!*\
  !*** ./node_modules/window.ipfs-fallback/index.js ***!
  \****************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _preact = __webpack_require__(/*! preact */ \"./node_modules/preact/dist/preact.esm.js\");\n\nvar _window = _interopRequireDefault(__webpack_require__(/*! window.ipfs-fallback */ \"./node_modules/window.ipfs-fallback/index.js\"));\n\nvar _pullStream = _interopRequireDefault(__webpack_require__(/*! pull-stream */ \"./node_modules/pull-stream/index.js\"));\n\nvar _pullAbortable = _interopRequireDefault(__webpack_require__(/*! pull-abortable */ \"./node_modules/pull-abortable/index.js\"));\n\nvar _PeerBandwidthTable = _interopRequireDefault(__webpack_require__(/*! ./PeerBandwidthTable */ \"./src/PeerBandwidthTable.js\"));\n\nvar _stats = __webpack_require__(/*! ./lib/stats */ \"./src/lib/stats.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar App =\n/*#__PURE__*/\nfunction (_Component) {\n  _inherits(App, _Component);\n\n  function App() {\n    _classCallCheck(this, App);\n\n    return _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).apply(this, arguments));\n  }\n\n  _createClass(App, [{\n    key: \"componentWillMount\",\n    value: function componentWillMount() {\n      var _this = this;\n\n      (0, _window.default)().then(function (ipfs) {\n        _this.setState({\n          ipfs: ipfs\n        });\n\n        _this._abortableNodeBw = (0, _pullAbortable.default)();\n        (0, _pullStream.default)((0, _stats.nodeBandwidth)(ipfs), _this._abortableNodeBw, _pullStream.default.drain(function (bw) {\n          return _this.setState({\n            bw: bw\n          });\n        }));\n      });\n    }\n  }, {\n    key: \"componentWillUnmount\",\n    value: function componentWillUnmount() {\n      this._abortableNodeBw.abort();\n    }\n  }, {\n    key: \"render\",\n    value: function render() {\n      var ipfs = this.state.ipfs;\n      return (0, _preact.h)(\"div\", {\n        className: \"pa3 mw8 center\"\n      }, (0, _preact.h)(\"div\", {\n        className: \"bg-white ba border-gray-muted br1 pa2\",\n        style: {\n          boxShadow: '0px 3px 6px 0 rgba(205,207,214,0.35)'\n        }\n      }, ipfs ? (0, _preact.h)(_PeerBandwidthTable.default, {\n        ipfs: ipfs\n      }) : null));\n    }\n  }]);\n\n  return App;\n}(_preact.Component);\n\nexports.default = App;\n\n//# sourceURL=webpack:///./src/App.js?");

/***/ }),

/***/ "./src/PeerBandwidthTable.js":
/*!***********************************!*\
  !*** ./src/PeerBandwidthTable.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _preact = __webpack_require__(/*! preact */ \"./node_modules/preact/dist/preact.esm.js\");\n\nvar _pullStream = _interopRequireDefault(__webpack_require__(/*! pull-stream */ \"./node_modules/pull-stream/index.js\"));\n\nvar _pullAbortable = _interopRequireDefault(__webpack_require__(/*! pull-abortable */ \"./node_modules/pull-abortable/index.js\"));\n\nvar _big = _interopRequireDefault(__webpack_require__(/*! big.js */ \"./node_modules/big.js/big.js\"));\n\nvar _stats = __webpack_require__(/*! ./lib/stats */ \"./src/lib/stats.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nvar EmptyBandwidth = {\n  rateIn: (0, _big.default)(0),\n  rateOut: (0, _big.default)(0),\n  totalIn: (0, _big.default)(0),\n  totalOut: (0, _big.default)(0)\n};\n\nvar PeerBandwidthTable =\n/*#__PURE__*/\nfunction (_Component) {\n  _inherits(PeerBandwidthTable, _Component);\n\n  function PeerBandwidthTable(props) {\n    var _this;\n\n    _classCallCheck(this, PeerBandwidthTable);\n\n    _this = _possibleConstructorReturn(this, (PeerBandwidthTable.__proto__ || Object.getPrototypeOf(PeerBandwidthTable)).call(this, props));\n    _this.state = {\n      peers: {},\n      sort: {\n        field: 'rateOut',\n        direction: -1\n      },\n      loading: true\n    };\n    _this.onFieldClick = _this.onFieldClick.bind(_assertThisInitialized(_this));\n    return _this;\n  }\n\n  _createClass(PeerBandwidthTable, [{\n    key: \"componentWillMount\",\n    value: function componentWillMount() {\n      var _this2 = this;\n\n      var ipfs = this.props.ipfs;\n      var peers = {};\n      var peerBw = (0, _stats.peerBandwidth)(ipfs);\n      this._abortableSwarmPeers = (0, _pullAbortable.default)();\n      this._abortablePeerBw = (0, _pullAbortable.default)();\n      (0, _pullStream.default)((0, _stats.swarmPeers)(ipfs), this._abortableSwarmPeers, _pullStream.default.drain(function (_ref) {\n        var event = _ref.event,\n            data = _ref.data;\n\n        if (event === 'add') {\n          peers[data.id] = {\n            id: data.id,\n            bw: EmptyBandwidth\n          };\n          peerBw.watch(data.id);\n        } else if (event === 'remove') {\n          delete peers[data.id];\n          peerBw.unwatch(data.id);\n        }\n      }));\n      (0, _pullStream.default)(peerBw, this._abortablePeerBw, _pullStream.default.drain(function (_ref2) {\n        var id = _ref2.id,\n            bw = _ref2.bw;\n        peers[id] = {\n          id: id,\n          bw: bw\n        };\n      }));\n\n      var updatePeerState = function updatePeerState() {\n        return _this2.setState({\n          peers: _objectSpread({}, peers),\n          loading: false\n        });\n      };\n\n      this._interval = setInterval(updatePeerState, this.props.refreshRate || 2000);\n    }\n  }, {\n    key: \"getSorter\",\n    value: function getSorter(_ref3) {\n      var field = _ref3.field,\n          direction = _ref3.direction;\n      return function (a, b) {\n        if (a.bw[field].gt(b.bw[field])) return direction;\n        if (a.bw[field].lt(b.bw[field])) return -direction;\n        return 0;\n      };\n    }\n  }, {\n    key: \"onFieldClick\",\n    value: function onFieldClick(e) {\n      this.setState(function (_ref4) {\n        var sort = _ref4.sort;\n        var field = e.currentTarget.getAttribute('data-field');\n        var direction = sort.field === field ? -sort.direction : -1;\n        return {\n          sort: {\n            field: field,\n            direction: direction\n          }\n        };\n      });\n    }\n  }, {\n    key: \"componentWillUnmount\",\n    value: function componentWillUnmount() {\n      clearInterval(this._interval);\n\n      this._abortableSwarmPeers.abort();\n\n      this._abortablePeerBw.abort();\n    }\n  }, {\n    key: \"render\",\n    value: function render() {\n      var _state = this.state,\n          peers = _state.peers,\n          sort = _state.sort,\n          loading = _state.loading;\n      var sortedPeers = Object.values(peers).sort(this.getSorter(sort));\n      return loading ? (0, _preact.h)(\"p\", {\n        className: \"sans-serif f3 ma0 pv1 ph2 tc\"\n      }, \"Loading...\") : (0, _preact.h)(\"table\", {\n        className: \"collapse\"\n      }, (0, _preact.h)(\"tr\", {\n        className: \"tl\"\n      }, (0, _preact.h)(\"th\", {\n        className: \"pv2 ph3 w-100\"\n      }, (0, _preact.h)(\"span\", {\n        className: \"v-mid\"\n      }, \"Peer\")), (0, _preact.h)(SortableTableHeader, {\n        field: \"rateIn\",\n        label: \"Rate In\",\n        sort: sort,\n        onClick: this.onFieldClick\n      }), (0, _preact.h)(SortableTableHeader, {\n        field: \"rateOut\",\n        label: \"Rate Out\",\n        sort: sort,\n        onClick: this.onFieldClick\n      }), (0, _preact.h)(SortableTableHeader, {\n        field: \"totalIn\",\n        label: \"Total In\",\n        sort: sort,\n        onClick: this.onFieldClick\n      }), (0, _preact.h)(SortableTableHeader, {\n        field: \"totalOut\",\n        label: \"Total Out\",\n        sort: sort,\n        onClick: this.onFieldClick\n      })), sortedPeers.map(function (p, i) {\n        return (0, _preact.h)(\"tr\", {\n          key: p.id,\n          className: i % 2 ? 'bg-snow-muted' : ''\n        }, (0, _preact.h)(\"td\", {\n          className: \"pv2 ph3 monospace\"\n        }, p.id), (0, _preact.h)(\"td\", {\n          className: \"pv2 ph3\"\n        }, p.bw.rateIn.toFixed(0)), (0, _preact.h)(\"td\", {\n          className: \"pv2 ph3\"\n        }, p.bw.rateOut.toFixed(0)), (0, _preact.h)(\"td\", {\n          className: \"pv2 ph3\"\n        }, p.bw.totalIn.toFixed(0)), (0, _preact.h)(\"td\", {\n          className: \"pv2 ph3\"\n        }, p.bw.totalOut.toFixed(0)));\n      }));\n    }\n  }]);\n\n  return PeerBandwidthTable;\n}(_preact.Component);\n\nexports.default = PeerBandwidthTable;\n\nfunction SortableTableHeader(_ref5) {\n  var field = _ref5.field,\n      label = _ref5.label,\n      sort = _ref5.sort,\n      onClick = _ref5.onClick;\n  return (0, _preact.h)(\"th\", {\n    className: \"pv2 ph3 pointer underline-hover nowrap\",\n    onClick: onClick,\n    \"data-field\": field\n  }, (0, _preact.h)(\"span\", {\n    className: \"v-mid\"\n  }, label), (0, _preact.h)(SortArrow, {\n    field: field,\n    sortField: sort.field,\n    direction: sort.direction\n  }));\n}\n\nfunction SortArrow(_ref6) {\n  var field = _ref6.field,\n      sortField = _ref6.sortField,\n      direction = _ref6.direction;\n  if (field !== sortField) return null;\n  var src = \"https://icon.now.sh/triangle\".concat(direction === 1 ? 'Up' : 'Down');\n  return (0, _preact.h)(\"img\", {\n    src: src,\n    className: \"v-mid\"\n  });\n}\n\n//# sourceURL=webpack:///./src/PeerBandwidthTable.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.swarmPeers = swarmPeers;\nexports.nodeBandwidth = nodeBandwidth;\nexports.peerBandwidth = peerBandwidth;\n\nvar _pullStream = _interopRequireDefault(__webpack_require__(/*! pull-stream */ \"./node_modules/pull-stream/index.js\"));\n\nvar _async = _interopRequireDefault(__webpack_require__(/*! async.queue */ \"./node_modules/async.queue/index.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction swarmPeers(ipfs, opts) {\n  opts = opts || {};\n  opts.interval = opts.interval || 5000;\n  var peers = {};\n  var first = true;\n\n  var source = function source(end, cb) {\n    if (end) return cb(end);\n\n    var getPeers = function getPeers() {\n      ipfs.swarm.peers(function (err, nextPeers) {\n        if (err) {\n          console.error('Failed to fetch swarm peers', err);\n          return cb(null, []);\n        }\n\n        nextPeers.forEach(function (np) {\n          np.id = np.peer.toB58String ? np.peer.toB58String() : np.peer.id.toB58String();\n        });\n        var added = nextPeers.filter(function (np) {\n          return !peers[np.id];\n        });\n        var removed = Object.keys(peers).filter(function (id) {\n          return nextPeers.every(function (np) {\n            return np.id !== id;\n          });\n        });\n        added.forEach(function (p) {\n          peers[p.id] = p;\n        });\n        removed.forEach(function (id) {\n          delete peers[id];\n        });\n        var changes = added.map(function (p) {\n          return {\n            event: 'add',\n            data: p\n          };\n        }).concat(removed.map(function (id) {\n          return {\n            event: 'remove',\n            data: {\n              id: id\n            }\n          };\n        }));\n        cb(null, changes);\n      });\n    };\n\n    if (first) {\n      first = false;\n      return getPeers();\n    }\n\n    setTimeout(getPeers, opts.interval);\n  };\n\n  return (0, _pullStream.default)(source, _pullStream.default.flatten());\n}\n\nfunction nodeBandwidth(ipfs, opts) {\n  opts = opts || {};\n  opts.interval = opts.interval || 5000;\n  var first = true;\n\n  var source = function source(end, cb) {\n    if (end) return cb(end);\n\n    var getBandwidth = function getBandwidth() {\n      ipfs.stats.bw(function (err, bw) {\n        if (err) {\n          console.error('Failed to fetch node bandwidth', err);\n          return cb();\n        }\n\n        cb(null, bw);\n      });\n    };\n\n    if (first) {\n      first = false;\n      return getBandwidth();\n    }\n\n    setTimeout(getBandwidth, opts.interval);\n  };\n\n  return (0, _pullStream.default)(source, _pullStream.default.flatten());\n}\n\nfunction peerBandwidth(ipfs, opts) {\n  opts = opts || {};\n  opts.interval = opts.interval || 5000;\n  opts.concurrency = opts.concurrency || 5;\n  var watches = {};\n  var bwData = [];\n  var onData;\n  var q = (0, _async.default)(function (id, cb) {\n    ipfs.stats.bw({\n      peer: id\n    }, function (err, bw) {\n      if (err) return cb(err); // Peer was unwatched while in queue?\n\n      if (!watches[id]) return cb();\n      bwData.push({\n        id: id,\n        bw: bw\n      });\n\n      if (onData) {\n        var onDataCallback = onData;\n        onData = null;\n        onDataCallback();\n      } // Deprioritise peers not transferring data\n\n\n      var interval = bw.rateIn.eq(0) && bw.rateOut.eq(0) ? opts.interval * 2 : opts.interval;\n      watches[id] = setTimeout(function () {\n        return q.push(id);\n      }, interval);\n      cb();\n    });\n  }, opts.concurrency);\n\n  var source = function source(end, cb) {\n    if (end) {\n      q.kill();\n      Object.keys(watches).forEach(source.unwatch);\n      return cb(end);\n    }\n\n    if (bwData.length) return cb(null, bwData.shift());\n\n    onData = function onData() {\n      return cb(null, bwData.shift());\n    };\n  };\n\n  source.watch = function (id) {\n    if (watches[id]) return console.warn('Already watching', id);\n    watches[id] = setTimeout(function () {\n      return q.push(id);\n    });\n  };\n\n  source.unwatch = function (id) {\n    if (!watches[id]) return;\n    clearTimeout(watches[id]);\n    delete watches[id];\n  };\n\n  return source;\n}\n\n//# sourceURL=webpack:///./src/lib/stats.js?");
